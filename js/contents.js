...
function sectionsVars(projects) {
  var recent = [];

  pullSection(projects).then(function(r) {
    for (var i = 0; i < 50; i++) {
      recent[i] = r.data[i];
    }
  })
...
function sections(articles, projects) {
